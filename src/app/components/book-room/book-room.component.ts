...
import { TypeRoomsService } from 'src/app/services/type-rooms.service';
import { custommer } from 'src/app/models/customer';
...
export class BookRoomComponent {
  ...
  constructor(private _liveAnnouncer: LiveAnnouncer,
    ...
    private roomTypesService: TypeRoomsService) {
    ...
    reservationService.getReservation().subscribe((data) => { this.reservations = data; });
